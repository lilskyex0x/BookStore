...
**The Bookstore** is a website similar to the "Awesome Books" website built in the previous module. This project is an simplified version of it that allows you to: Display a list of books, Add a book, Remove a selected book.
...
```sh
  cd my-folder
  git clone https://github.com/lilskyex0x/BookStore.git
```
